...
public record IfExpression(org.key_project.smartml.ast.expr.Expr condition, ThenBranch thenExpr, @Nullable ElseBranch elseExpr) implements Expr, ElseBranch {
    @Override
