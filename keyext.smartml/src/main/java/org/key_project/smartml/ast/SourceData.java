 ...
 * {@link #getSource()}. The rough idea is to store the parent ast node and the index of the child
...
public class SourceData {
     ...
     */
    private SmartMLProgramElement element;
     ...
     */
    public SourceData(SmartMLProgramElement element, int childPos, Services services) {
     ...
     */
    public void setElement(SmartMLProgramElement element) {
        this.element = element;
    }
    ...
    public SmartMLProgramElement getSource() {
        ...
        if (childPos < element.getChildCount()) {
            return (SmartMLProgramElement) element.getChild(childPos);
        } else {
            return null;
        }
    }
