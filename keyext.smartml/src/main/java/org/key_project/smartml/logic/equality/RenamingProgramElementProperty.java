...
package org.key_project.smartml.logic.equality;
...
//import org.key_project.smartml.ast.stmt.LetStatement;
import org.key_project.smartml.logic.NameAbstractionTable;
import org.key_project.smartml.logic.equality.EqualsModProperty;
import org.key_project.smartml.logic.op.ProgramVariable;

import java.util.HashMap;
import java.util.Map;

public class RenamingProgramElementProperty implements Property<SmartMLProgramElement> {
    /**
    ...
    @Override
    public int hashCodeModThisProperty(SmartMLProgramElement SmartMLProgramElement) {
        /*
         * Currently, the best approach seems to be to walk through the SmartMLProgramElement with a
        ...
        int hashCode = 1;
        SyntaxElementCursor c = SmartMLProgramElement.getCursor();
        SyntaxElement next;
        ...
        do {
           ...
           /* if (next instanceof LetStatement ls) {
                ...
                hashCode = 31 * hashCode + absMap.getAbstractName((SmartMLProgramElement) next);
    ...
    private boolean handleStandard(SyntaxElement se1, SyntaxElement se2) {
        /*
         * As the prior implementations of equalsModRenaming for SmartMLProgramElements were mostly
         * the same
    ...
    private boolean handleSmartMLNonTerminalProgramElement(SyntaxElement rnte,
            SyntaxElement se) {
        /*
         * A TODO ProgramElement is a special case of a SmartMLProgramElement, as we must
         * not
...
*/
    ...
    private boolean handleProgramVariableOrElementName(SyntaxElement se1, SyntaxElement se2,
            NameAbstractionTable nat) {
        /*
         * A ProgramVariable or a ProgramElementName is a special case of a SmartMLProgramElement and
         * one
        ...
        return nat.sameAbstractName((SmartMLProgramElement) se1, (SmartMLProgramElement) se2);
    }
    ...
    /**
     * A helper class to map {@link SmartMLProgramElement}s to an abstract name.
     * <p>
    ...
    private static class NameAbstractionMap {
        /**
         * The map that associates {@link SmartMLProgramElement}s with their abstract names.
         */
        private final Map<SmartMLProgramElement, Integer> map = new HashMap<>();

        /**
         * Adds a {@link SmartMLProgramElement} to the map.
         *
         * @param element the {@link SmartMLProgramElement} to be added
         */
        public void add(SmartMLProgramElement element) {
            map.put(element, map.size());
        }

        /**
         * Returns the abstract name of a {@link SmartMLProgramElement} or {@code -1} if the element
         * is not
         * in the map.
         * <p>
         ...
         *
         * @param element the {@link SmartMLProgramElement} whose abstract name should be returned
         * @return the abstract name of the {@link SmartMLProgramElement} or {@code -1} if the element
         *         is
         *         not in the map
         */
        public int getAbstractName(SmartMLProgramElement element) {
