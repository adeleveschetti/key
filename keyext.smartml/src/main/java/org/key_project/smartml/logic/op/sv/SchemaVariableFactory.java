...
public class SchemaVariableFactory {
     ...
     * @return the SchemaVariable
     */
    public static org.key_project.smartml.logic.op.sv.TermSV createTermSV(Name name, Sort sort, boolean rigidness, boolean strictSV) {
        return new org.key_project.smartml.logic.op.sv.TermSV(name, sort, rigidness, strictSV);
    }
