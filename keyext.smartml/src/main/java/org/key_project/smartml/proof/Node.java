...
import org.key_project.smartml.proof.NodeIterator;
import org.key_project.smartml.proof.Proof;
import org.key_project.smartml.proof.SubtreeIterator;
...
public class Node implements Iterable<Node> {
    ...
    private final org.key_project.smartml.proof.Proof proof;

    /** The parent node. **/
    private @Nullable Node parent = null;

    private Sequent seq = SmartMLSequentKit.getInstance().getEmptySequent();
     ...
     */
    private Node(org.key_project.smartml.proof.Proof proof) {
        this.proof = proof;
     ...
     */
    public Node(org.key_project.smartml.proof.Proof proof, Sequent seq) {
        this(proof);
        this.seq = seq;
    }
     ...
     */
    public Node(org.key_project.smartml.proof.Proof proof, Sequent seq, @Nullable Node parent) {
        this(proof, seq);
        this.parent = parent;
    }
