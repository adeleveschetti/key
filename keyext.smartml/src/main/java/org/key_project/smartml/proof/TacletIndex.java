...
public class TacletIndex {
    ...
    private static Object getIndexObj(FindTaclet tac) {
        ...
        if (indexTerm.op() instanceof Modality mod) {
            final SmartMLProgramElement prg = mod.program().program();
     ...
     *                          prefix elements
     */
    private ImmutableList<NoPosTacletApp> getSmartMLTacletList(
            HashMap<Object, ImmutableList<NoPosTacletApp>> map, SmartMLProgramElement pe,
        ...
        if (pe instanceof ProgramPrefix) {
            ...
            if (next < nt.getChildCount()) {
                return getSmartMLTacletList(map, (SmartMLProgramElement) nt.getChild(next),
                        prefixOccurrences);
            }
        } else {
    ...
    private ImmutableList<NoPosTacletApp> getListHelp(
      ...
      /*  if (op instanceof Modality mod) {
            ...
            res = getSmartMLTacletList(map, (SmartMLProgramElement) sb.getChild(0), prefixOccurrences);
        }*/
    ...
    private static class PrefixOccurrences {
        static final int PREFIXTYPES = 100; //TODO: this is wrong!!
        ...
        public int occurred(SmartMLProgramElement pe) {
