...
public class Statistics {
    ...
    public Statistics(List<org.key_project.smartml.proof.Node> startNodes) {
        ...
        for (org.key_project.smartml.proof.Node startNode : startNodes) {
            final Iterator<org.key_project.smartml.proof.Node> it = startNode.subtreeIterator();

            TemporaryStatistics tmp = new TemporaryStatistics();

            org.key_project.smartml.proof.Node node;
            while (it.hasNext()) {
                node = it.next();
    ...
    Statistics(org.key_project.smartml.proof.Node startNode) {
        final Iterator<org.key_project.smartml.proof.Node> it = startNode.subtreeIterator();
    ...
    Statistics(org.key_project.smartml.proof.Proof proof) {
        this(proof.root());
    }
    ...
    private static class TemporaryStatistics {
         ...
         */
        private void changeOnNode(final org.key_project.smartml.proof.Node node) {
            nodes++;
         ...
         */
        private int childBranches(final org.key_project.smartml.proof.Node node) {
         ...
         */
        private int cachedBranches(final org.key_project.smartml.proof.Node node) {
