...
public class SmartMLSequentKit extends SequentKit {
    ...
    public Semisequent getEmptySemisequent() {
        return org.key_project.smartml.proof.calculus.Semisequent.EMPTY_SEMISEQUENT;
    }


    @Override
    public Sequent getEmptySequent() {
        return org.key_project.smartml.proof.calculus.Sequent.EMPTY_SEQUENT;
    }
    ...
    protected Sequent createSequent(Semisequent ante, Semisequent succ) {
        ...
        return new org.key_project.smartml.proof.calculus.Sequent(ante, succ);
    }
    ...
    protected Semisequent createSemisequent(ImmutableList<SequentFormula> sequentFormulas) {
        return sequentFormulas.isEmpty()
                ...
                : new org.key_project.smartml.proof.calculus.Semisequent(sequentFormulas);
    }
