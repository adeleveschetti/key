...
import org.key_project.smartml.proof.io.RuleSourceFactory;
...
public class IncludeFinder extends AbstractBuilder<Void> {
    ...
    @Override
    public Void visitOne_include_statement(KeYSmartMLParser.One_include_statementContext ctx) {
    ...
    @Override
    public Void visitOne_include(KeYSmartMLParser.One_includeContext ctx) {
