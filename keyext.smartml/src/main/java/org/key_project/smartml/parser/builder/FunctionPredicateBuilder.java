...
public class FunctionPredicateBuilder extends DefaultBuilder {
    ...
    public Object visitDatatype_decl(KeYSmartMLParser.Datatype_declContext ctx) {
        ...
        for (KeYSmartMLParser.Datatype_constructorContext constructorContext : ctx
    ...
    @Override
    public Object visitPred_decl(KeYSmartMLParser.Pred_declContext ctx) {
        ...
        if (separatorIndex > 0) {
            ...
            // new Name(baseName), SmartMLDLTheory.FORMULA, argSorts.toArray(new Sort[0]), false);
            // }
        }

        if (p == null) {
            assert argSorts != null;
            p = new RFunction(new Name(pred_name), SmartMLDLTheory.FORMULA,
    ...
    @Override
    public Object visitFunc_decl(KeYSmartMLParser.Func_declContext ctx) {
    ...
    @Override
    public Object visitFunc_decls(KeYSmartMLParser.Func_declsContext ctx) {
        return mapOf(ctx.func_decl());
    }

    public Object visitPred_decls(KeYSmartMLParser.Pred_declsContext ctx) {
