...
//import org.key_project.smartml.logic.op.IfThenElse;
import org.key_project.smartml.logic.op.Junctor;
...
import org.key_project.smartml.rule.executor.smartmldl.RewriteTacletExecutor;
...
public class RewriteTaclet extends FindTaclet {
     ...
     * <li>{@link ApplicationRestriction#SAME_UPDATE_LEVEL} then <code>\assumes</code>
     * must match on a
     ...
     * <li>{@link ApplicationRestriction#IN_SEQUENT_STATE} the <code>\find</code> part
     * is only allowed to
    ...
    public org.key_project.smartml.rule.MatchConditions checkPrefix(PosInOccurrence p_pos, MatchConditions p_mc) {
