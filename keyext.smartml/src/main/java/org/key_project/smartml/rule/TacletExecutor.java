...
import org.key_project.smartml.rule.SyntacticalReplaceVisitor;
...
public abstract class TacletExecutor extends
        org.key_project.prover.rules.TacletExecutor<@NonNull Goal, org.key_project.smartml.rule.TacletApp> {
    protected TacletExecutor(org.key_project.smartml.rule.Taclet taclet) {
        super(taclet);
    }
     ...
     * @param mc the {@link org.key_project.smartml.rule.MatchConditions} with all instantiations and the constraint
    ...
    protected Term syntacticalReplace(Term term, PosInOccurrence applicationPosInOccurrence,
                                      org.key_project.smartml.rule.MatchConditions mc, Goal goal, org.key_project.smartml.rule.TacletApp ruleApp, Services services) {
    ...
    protected Term syntacticalReplace(Term term, PosInOccurrence applicationPosInOccurrence,
        ...
        return syntacticalReplace(term, applicationPosInOccurrence, (org.key_project.smartml.rule.MatchConditions) mc, goal,
