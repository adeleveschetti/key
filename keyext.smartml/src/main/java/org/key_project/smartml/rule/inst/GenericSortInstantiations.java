...
import org.key_project.smartml.rule.inst.GenericSortException;
...
public final class GenericSortInstantiations {
    ...
    public static GenericSortInstantiations create(
            ...
            ImmutableList<org.key_project.smartml.rule.inst.GenericSortCondition> p_conditions, LogicServices services) {

        ImmutableList<GenericSort> sorts = ImmutableSLList.nil();
        org.key_project.smartml.rule.inst.GenericSortCondition c;

        final Iterator<org.key_project.smartml.rule.inst.GenericSortCondition> it;
        ...
        while (p_instantiations.hasNext()) {
            ...
            c = org.key_project.smartml.rule.inst.GenericSortCondition.createCondition(entry.key(), entry.value());
            if (c != null) {
    ...
    public Boolean checkSorts(OperatorSV sv, InstantiationEntry<?> p_entry) {
        ...
        final org.key_project.smartml.rule.inst.GenericSortCondition c = org.key_project.smartml.rule.inst.GenericSortCondition.createCondition(sv, p_entry);
        if (c != null) {
        ...
        if (org.key_project.smartml.rule.inst.GenericSortCondition.subSortsAllowed(sv)) {
     ...
     */
    public Boolean checkCondition(org.key_project.smartml.rule.inst.GenericSortCondition p_condition) {
     ...
     */
    public ImmutableList<org.key_project.smartml.rule.inst.GenericSortCondition> toConditions() {
        ImmutableList<org.key_project.smartml.rule.inst.GenericSortCondition> res = ImmutableSLList.nil();


        for (final ImmutableMapEntry<GenericSort, Sort> entry : insts) {
            res = res.prepend(
                org.key_project.smartml.rule.inst.GenericSortCondition.createIdentityCondition(entry.key(), entry.value()));
        }
    ...
    private static ImmutableMap<GenericSort, Sort> solveHelp(
            ...
            ImmutableList<org.key_project.smartml.rule.inst.GenericSortCondition> p_conditions,
        ...
        ImmutableList<org.key_project.smartml.rule.inst.GenericSortCondition> idConditions =
            ImmutableSLList.nil();

        // subsorts given by the conditions (could be made faster
        // by using a hash map for storing the conditions)
        {
            for (org.key_project.smartml.rule.inst.GenericSortCondition c : p_conditions) {
                if (c.getGenericSort() == gs) {
                    if (c instanceof org.key_project.smartml.rule.inst.GenericSortCondition.GSCSupersort) {
                        subsorts =
                            subsorts.prepend(((org.key_project.smartml.rule.inst.GenericSortCondition.GSCSupersort) c).getSubsort());
                    } else if (c instanceof org.key_project.smartml.rule.inst.GenericSortCondition.GSCIdentity) {
    ...
    private static ImmutableList<Sort> chooseResults(GenericSort p_gs,
            ImmutableList<org.key_project.smartml.rule.inst.GenericSortCondition> p_idConditions) throws FailException {
        if (!p_idConditions.isEmpty()) {
            // then the instantiation is completely determined by
            // an identity condition
            final Iterator<org.key_project.smartml.rule.inst.GenericSortCondition> itC = p_idConditions.iterator();
    ...
    private static Sort condSort(Iterator<org.key_project.smartml.rule.inst.GenericSortCondition> itC) {
        return ((org.key_project.smartml.rule.inst.GenericSortCondition.GSCIdentity) itC.next()).getSort();
    }
