...
import org.key_project.smartml.rule.NewVarcond;
import org.key_project.smartml.rule.Taclet;
import org.key_project.smartml.rule.VariableCondition;
...
public abstract class TacletBuilder<T extends Taclet> {
    ...
    protected Sequent ifseq = SmartMLSequentKit.getInstance().getEmptySequent();
     ...
     * given type
     */
    public void addVarsNew(SchemaVariable v, KeYSmartMLType type) {
        if (type == null) {
