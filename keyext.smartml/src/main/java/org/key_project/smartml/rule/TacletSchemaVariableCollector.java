...
import org.key_project.smartml.ast.visitor.ProgramSVCollector;
...
import org.key_project.smartml.rule.tacletbuilder.RewriteTacletGoalTemplate;
...
public class TacletSchemaVariableCollector implements Visitor<@NonNull Term> {
     ...
     */
    protected ImmutableList<SchemaVariable> collectSVInProgram(SmartMLBlock rb,
     ...
     */
    public void visit(org.key_project.smartml.rule.Taclet taclet, boolean visitAddrules) {
    ...
    protected void visitFindPart(org.key_project.smartml.rule.Taclet taclet) {
    ...
    protected void visitGoalTemplates(org.key_project.smartml.rule.Taclet taclet, boolean visitAddrules) {
        for (var tacletGoalTemplate : taclet.goalTemplates()) {
            ...
            if (visitAddrules) {
                for (var taclet1 : tacletGoalTemplate.rules()) {
                    visit((org.key_project.smartml.rule.Taclet) taclet1, true);
                }
            }
        }
    }
