...
import org.key_project.smartml.rule.NoFindTaclet;
import org.key_project.smartml.rule.RewriteTaclet;
import org.key_project.smartml.rule.UninstantiatedNoPosTacletApp;
...
public class NoPosTacletApp extends TacletApp {
    ...
    protected MatchConditions setupMatchConditions(PosInOccurrence pos, Services services) {
        ...
        org.key_project.smartml.rule.MatchConditions mc;
        if (svInst.isEmpty()) {
            mc = org.key_project.smartml.rule.MatchConditions.EMPTY_MATCHCONDITIONS;
        } else {
            mc = new org.key_project.smartml.rule.MatchConditions(svInst);
        }
    ...
    private NoPosTacletApp evalCheckRes(MatchConditions res, Services services) {
        ...
        if (updateContextFixed
                && !updateContextCompatible((org.key_project.smartml.rule.MatchConditions) res)) {
            /*
    ...
    private boolean updateContextCompatible(org.key_project.smartml.rule.MatchConditions p_mc) {
