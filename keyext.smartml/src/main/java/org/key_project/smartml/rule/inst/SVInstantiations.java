...
public class SVInstantiations
   ...
   public SVInstantiations add(SchemaVariable sv, ProgramList pes, LogicServices services) {
     ...
     */
    public SVInstantiations add(SchemaVariable sv, Modality.SmartMLModalityKind kind,
   ...
   public SVInstantiations add(SchemaVariable sv, SmartMLProgramElement pe, LogicServices services) {
    ...
    public Term getTermInstantiation(SchemaVariable sv, LogicServices services) {
        ...
        if (inst == null) {
            ...
            return (Term) inst;
        } else if (inst instanceof SmartMLProgramElement pe) {
    ...
    public SVInstantiations addUpdate(Term update) {
        assert update.sort() == SmartMLDLTheory.UPDATE;
    ...
    public SVInstantiations replace(PosInProgram prefix, PosInProgram postfix,
            SmartMLProgramElement pe, Services services) {
