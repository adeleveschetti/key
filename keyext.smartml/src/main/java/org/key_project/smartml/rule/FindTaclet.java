...
public abstract class FindTaclet extends Taclet {
    ...
    protected FindTaclet(Name name, TacletApplPart applPart,
        ...
        super(name, applPart, goalTemplates, ruleSets, attrs, prefixMap, surviveSymbExec,
            tacletAnnotations);
        this.find = find;
    }
    ...
    protected FindTaclet(Name name, TacletApplPart applPart,
            ...
            ImmutableMap<SchemaVariable, org.key_project.prover.rules.TacletPrefix> prefixMap,
            ImmutableSet<org.key_project.prover.rules.TacletAnnotation> tacletAnnotations) {
        this(name, applPart, goalTemplates, ruleSets, attrs, find, prefixMap, false,
            tacletAnnotations);
    }
    ...
    public ImmutableSet<SchemaVariable> getAssumesAndFindVariables() {
        if (ifFindVariables == null) {
            org.key_project.smartml.rule.TacletSchemaVariableCollector svc = new TacletSchemaVariableCollector();
