...
import org.key_project.smartml.logic.op.BoundVariable;
import org.key_project.smartml.logic.op.LogicVariable;
import org.key_project.smartml.logic.op.RFunction;
import org.key_project.smartml.logic.op.sv.*;
import org.key_project.smartml.logic.sort.ProgramSVSort;
import org.key_project.smartml.proof.VariableNameProposer;
...
public abstract class TacletApp implements RuleApp {
     ...
     */
    protected final org.key_project.smartml.rule.inst.SVInstantiations instantiations;

    /**
     * caches a created match condition {@code (instantiations, RenameTable.EMPTY)}
     */
    private final org.key_project.smartml.rule.MatchConditions matchConditions;
    ...
    TacletApp(Taclet taclet) {
        this(taclet, org.key_project.smartml.rule.inst.SVInstantiations.EMPTY_SVINSTANTIATIONS, null);
    }

    TacletApp(Taclet taclet, SVInstantiations instantiations,
              ImmutableList<AssumesFormulaInstantiation> ifInstantiations) {
        this.taclet = taclet;
        this.instantiations = (org.key_project.smartml.rule.inst.SVInstantiations) instantiations;
        this.assumesInstantiations = ifInstantiations;
        this.matchConditions = new org.key_project.smartml.rule.MatchConditions(this.instantiations);
    }
     ...
     */
    public org.key_project.smartml.rule.inst.SVInstantiations instantiations() {
        return instantiations;
    }

    public org.key_project.smartml.rule.MatchConditions matchConditions() {
    ...
    public SmartMLProgramElement getProgramElement(String instantiation, ProgramSV sv,
            Services services) {
        Sort svSort = sv.sort();
     ...
     *
     */
    public TacletApp addCheckedInstantiation(SchemaVariable sv, SmartMLProgramElement pe,
