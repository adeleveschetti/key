...
import org.key_project.smartml.ast.expr.PathExpression;
...
public class MatchProgramSVInstruction extends MatchSchemaVariableInstruction<@NonNull ProgramSV>
    ...
    public MatchConditions match(Operator instantiationCandidate,
            ...
            LogicServices services) {
        if (instantiationCandidate instanceof SmartMLProgramElement pe) {
    ...
    public MatchConditions match(
            SmartMLProgramElement instantiationCandidate,
            MatchConditions matchCond,
            LogicServices services) {
        final ProgramSVSort svSort = (ProgramSVSort) op.sort();
     ...
     */
    private MatchConditions addInstantiation(SmartMLProgramElement pe, MatchConditions matchCond,
            Services services) {
    ...
    public static Term convertToLogicElement(SmartMLProgramElement pe, Services services) {
        ...
        if (pe instanceof PathExpression) {
            Identifier var = ((PathExpression) pe).var();
